# 最新更新
    ...
    3.用rust重写了后端,性能提高了很多,练手的项目,也比较完善了,完美切换后台
    4.由于小贝壳太贵了,国内还没有渠道买到,买的到又被海关查,20%的税太高了
    直接用了欧态+780手动模式,幸好欧态提供一个向nightscout同步数据的功能,所以rust的服务添加了一组ns接口,现在可以直接显示欧态的血糖数据了
    同时还添加了报警功能,一个欧态可以用14天,价格只要60-100元,比小贝壳便宜多了
